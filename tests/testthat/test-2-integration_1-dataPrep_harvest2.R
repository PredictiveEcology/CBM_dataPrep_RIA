...
test_that("Integration: CBM_dataPrep - harvest2", {
  ...
  # Set project path
  projectPath <- file.path(spadesTestPaths$temp$projects, "1-intg-1-dataPrep_harvest2")
  ...
  expect_equal(nrow(simTest$disturbanceEvents), 2149)
